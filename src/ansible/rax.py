...
def cloudservers(module, state=None, name=None, flavor=None, image=None,
                 ...
                 config_drive=False, delete_youngest=False):
    cs = pyrax.cloudservers
    ...
    if state == 'present':
        ...
        if exact_count is not False:
            ...
            # this is where we try to delete the right servers
            # if delete_oldest = true, delete oldest
            # if delete_newest = true, delete newest
...
def main():
    ...
    argument_spec.update(
        dict(
            ...
            delete_youngest=dict(default=False, type='bool'),
        )
    )
    ...
    delete_youngest = module.params.get('delete_youngest')
    ...
    cloudservers(module, state=state, name=name, flavor=flavor,
                 ...
                 config_drive=config_drive, delete_youngest=delete_youngest)
